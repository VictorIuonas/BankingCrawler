...
from InternetBankingCrawler.spiders.InternetBankingCrawler import SearchRepoSpider


class TestSpiders:

    @patch('InternetBankingCrawler.spiders.services.open')
    @patch('InternetBankingCrawler.spiders.SearchRepo.Spider')
